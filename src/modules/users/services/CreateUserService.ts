...
class CreateUserService {
  ...
  public async createUserThroughSocialLogin(user: ICreateUserThroughOauthDTO): Promise<User> {
    const createdUser = await this.userRepository.createUserThroughOauth({
